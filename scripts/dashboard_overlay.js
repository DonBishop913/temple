...
function updateOverlay() {
  ...
  const currentMission = councilMissions[Math.floor(Math.random() * councilMissions.length)];
  ...
  const updated = {
    ...
    copilot_status: "🛠️ GitHub Copilot: Active and synchronized with Council eternal trace",
