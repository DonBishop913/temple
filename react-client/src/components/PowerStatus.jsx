  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
        <div>
          <div>
            Main: <strong>{status.mainPower}</strong>
          </div>
          <div>
            Backup: <strong>{status.backupPower}</strong>
          </div>
        </div>
        <div>
          <div>
            Battery: <strong>{status.batteryLevel ?? "N/A"}%</strong>
          </div>
          <div>
            Solar: <strong>{status.solarOutput ?? "N/A"}W</strong>
          </div>
        </div>
