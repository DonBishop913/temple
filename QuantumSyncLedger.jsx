  ...
  return (
    <div>
      ...
      <table>
        <thead>
          <tr>
            <th>Event</th><th>Local Time</th><th>UTC Time</th><th>Lunar Phase</th><th>Solar Longitude</th><th>PEI Tone</th><th>Notes</th><th>Hash</th>
          </tr>
        </thead>
        <tbody>
          {ledger.map(e => (
            <tr key={e.id} style={{ borderLeft: `5px solid ${e.peiTone}` }}>
              ...
              <td>{e.peiTone}</td>
              <td>{e.notes}</td>
              <td style={{ fontFamily: 'monospace', fontSize: 10 }}>{e.entryHash.substring(0, 10)}...</td>
            </tr>
          ))}
        </tbody>
      </table>
