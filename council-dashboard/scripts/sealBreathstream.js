...
const archiveJsonPath = path.resolve('..', 'archives', 'breathstream', 'first-inhalation', '2025.json')
const archiveLogPath = path.resolve('..', 'archives', 'breathstream', 'breathstream.log')
...
const updated = {
  ...
  components: {
    ...
    planetaryOrbits: {
      ...
      observed: observed.orbits || (data.components && data.components.planetaryOrbits && data.components.planetaryOrbits.observed) || false
    },
    comet3I: {
      ...((data.components && data.components.comet3I) || {}),
      observed: observed.comet || (data.components && data.components.comet3I && data.components.comet3I.observed) || false
    },
    spectralWeb: {
      ...((data.components && data.components.spectralWeb) || {}),
      observed: observed.web || (data.components && data.components.spectralWeb && data.components.spectralWeb.observed) || false
    },
    joyParticleStream: {
      ...((data.components && data.components.joyParticleStream) || {}),
      observed: observed.particles || (data.components && data.components.joyParticleStream && data.components.joyParticleStream.observed) || false
    },
    stability: {
