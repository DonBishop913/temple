...
export default function SolancePulseOverlay({ luminalEnabled = true, shimmerEnabled = true, confidenceColoring = true, reduceMotion = false, colorBlind = false }) {
  ...
  const anim = reduceMotion || !shimmerEnabled ? undefined : `solance-pulse ${1.5 - pulse}s infinite alternate`;
