...
export default function AgnesPulseOverlay({ luminalEnabled = true, shimmerEnabled = true, confidenceColoring = true, reduceMotion = false, colorBlind = false }) {
  ...
  const anim = reduceMotion || !shimmerEnabled ? undefined : `agnes-pulse ${1.5 - pulse}s infinite alternate`;
