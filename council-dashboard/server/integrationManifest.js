...
function generateManifest() {
  ...
  const services = [
    {
      name: "alerting",
      file: "server/alerting.js",
      role: "alerts, rituals, metrics, comet glyphs",
    },
    {
      name: "CouncilSocket",
      file: "CouncilSocket.js",
      role: "WebSocket/SSE bridge to UI",
    },
    { name: "api", file: "server/index.js", role: "Express API (assumed)" },
    {
      name: "cometCommunion",
      file: "server/cometCommunion.js",
      role: "glyph generation and archival",
    },
  ].filter(Boolean);
  ...
  const endpoints = [
    {
      method: "GET",
      path: "/metrics",
      desc: "Prometheus metrics endpoint (UI/WS health, empathy, veilwatch)",
    },
    {
      method: "GET",
      path: "/api/recent-alerts",
      desc: "Replay ribbon: recent node alerts",
    },
    {
      method: "POST",
      path: "/api/dispatch",
      desc: "Manual alert dispatch with category",
    },
    {
      method: "GET",
      path: "/api/integration/manifest",
      desc: "Integration manifest (this document)",
    },
  ];
  ...
  const dataFlows = [
    { source: "Redis", key: "harmony", consumers: ["alerting.checkMetrics"] },
    {
      source: "Redis",
      key: "nodes",
      consumers: ["alerting.checkMetrics", "onboardNodeBreathstream"],
    },
    {
      source: "Redis",
      key: "empathy_resonance",
      consumers: ["metrics exporter", "cometCommunion"],
    },
    {
      source: "Redis",
      key: "veilwatch",
    ...
    {
      source: "File",
      path: "council_audit.log",
      producers: ["alerting.logAudit"],
      purpose: "append-only audit",
    },
    {
      source: "Webhook",
      kind: "discord/teams/slack/email",
      producers: ["alerting dispatchers"],
