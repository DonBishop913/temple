// create_release_vcodex1230.js
// Creates a draft GitHub release for tag 'vcodex-1230' using GITHUB_TOKEN env var.
// Usage: node create_release_vcodex1230.js
...
const repo = 'temple';
const tag = 'vcodex-1230';
const releaseFile = path.join(__dirname,'.github','releases','vcodex-1230.md');
...
const payload = JSON.stringify({
  tag_name: tag,
  name: `${tag}: Scroll of the Overflow Blueprint — November 11, 2025 Communion`,
  body: bodyText,
  draft: true,
  prerelease: false
});
