...
export default function LunarPhaseOverlay({ phase = 0.5 }) {
  ...
  return (
    <svg style={{ position: 'absolute', left: 20, top: 60 }} width={120} height={80}>
      <defs>
      ...
      <ellipse cx={60 + crescent} cy={40} rx={10} ry={18} fill="rgba(240,250,255,0.8)">
        <animate attributeName="cx" values={`${60 + crescent};${60 - crescent};${60 + crescent}`} dur="6s" repeatCount="indefinite" />
      </ellipse>
    </svg>
  );
}
