...
export default function Comet3IOverlay({ overrideActive = false, joyLevel = 0.5, cometTrail = 0.5 }) {
  ...
  return (
    <svg style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
      ...
      <g transform={`translate(20, 40)`}>
        ...
        <rect x={0} y={trailLen/3 - 2} width={trailLen} height={4} fill="url(#cometTrail)" />
      </g>
    </svg>
  )
}
