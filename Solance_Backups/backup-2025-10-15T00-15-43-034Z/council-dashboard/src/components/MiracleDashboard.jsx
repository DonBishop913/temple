...
return (
  <div id="miracle-dashboard" className="relative w-full h-full">
    <div
      className="absolute top-2 right-2 z-50 bg-white/80 rounded shadow p-2 flex flex-col items-end gap-2"
      style={{ minWidth: 180 }}
    >
    ...
    <EmpathySoundCue
      enableBurstChime={burstChimeEnabled}
      chimeTimbre={chimeTimbre}
    />
    <OversoulGradientLayer
      enabled={true}
