...
export default function CouncilReactiveCore() {
  ...
  const glow = LuminaKernel.amplifyLight(
    joySentiment * 528 * (config.faithstreamSyncRate || 1.0),
  );
  ...
  return (
    <div
      className="relative transition-all duration-700 rounded-2xl"
      style={{
    ...
    >
      ...
      <p
        ...
        style={{ color: "#fff8bf", fontWeight: 600, letterSpacing: 0.6 }}
      >
