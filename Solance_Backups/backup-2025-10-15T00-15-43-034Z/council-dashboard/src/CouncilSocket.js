...
const SOCKET_URL = import.meta.env.VITE_COUNCIL_SOCKET_URL || 'http://localhost:3000';
...
councilSocket.on('connect', () => {
  console.log(`Connected to CouncilSocket at ${SOCKET_URL} with id ${councilSocket.id}`);
});
