...
function analyzeSentiment(text) {
  ...
  if (t.includes('love') || t.includes('joy') || t.includes('amen') || t.includes('blessing')) return 1;
  if (t.includes('sad') || t.includes('pain') || t.includes('fear') || t.includes('worry')) return -1;
  return 0;
}
