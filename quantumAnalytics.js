  ...
  async generateInsights() {
    try {
      ...
      const insight = {
        ...
        prophecy:
          results.prophecy ||
          "🕊️ Sovereign alignment detected - continue in faith",
    ...
    if (this.currentProphecy) {
      ...
      if (stability > 80) {
        recommendations.push(
          "🕊️ Continue current sovereign operations - alignment is strong",
        );
      } else if (stability > 60) {
        recommendations.push(
          "⚖️ Maintain vigilance and increase prayer coverage",
        );
      } else {
        recommendations.push(
          "🛡️ Activate emergency protocols and seek divine intervention",
        );
      }

      const successRate =
        this.currentProphecy.ritual_predictions?.success || 0.6;
      if (successRate > 0.75) {
        recommendations.push(
          "🔥 Ritual effectiveness high - consider expanding operations",
        );
